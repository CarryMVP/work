...
function() {
	...
	function r() {
		$.os.phone || $.os.tablet || (new QRCode(s.children()[0]).makeCode(location.href), $("body").children().hide(), s.show())//生成二维码
	}
	function i() {
		console.log('分享');
	}
	...
	function e() {  //动效
		setTimeout(function() {
			...
			$(".ele3_light, .ele2_light, .img1").addClass("active")
		}, 1400)
	}
	function n() {
		function t(t) {  //监听音乐
		...
		/*$(".btn_start").on("touchend", function() {   //开始
		//	document.getElementById('speak').play();
			$(".cover").hide(), $(".content").show(), setTimeout(function() {
				$(".content .page0 .block1").addClass("active")
			}, 100), setTimeout(function() {
				$(".content .page1 .title1").addClass("active")
			}, 600), setTimeout(function() {
				$(".content .page0 .block2").addClass("active")
			}, 1100)
		});*/
		//$('#speak_click').on("touchend", function() {   //开始
		//	document.getElementById('speak1').play();
		//});
		var e = $(".music"),
			n = $("#audio")[0];
		e.on("click", function() {
		...
		}), $(".pop .pop_close").on("click", function() {  // 弹出框
			$(".pop").hide(), $(".common-container").css({
				overflow: "auto"
			})
		}),**/ $(".btn_share").on("click", function() {  //点击分享
			NewsAppShare && NewsAppShare.show()
		}), $(".btn_app").on("click", function() {
			window.location.href = "http://app.21jingji.com/html/20171015abroad/index.html"
		});
